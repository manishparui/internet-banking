...
/**
 * Servlet implementation class AccCloseServ
 */
public class AccCloseServ extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String acno = request.getParameter("accreqcloseaccno");
		AccountsDAO adao = new AccountsDAO();
		adao.deactivateOne(acno);
		...
		out.print("<link rel=\"stylesheet\" type=\"text/css\" href=\"snackbar/snackbar.css\">"
				...
				+ "<div id=\"snackbar\">Account Closed.</div>"
